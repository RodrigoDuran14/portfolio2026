...
const About = ({ data }) => {
  ...
  return (
    <section id="about" className="pt-32 pb-20 md:pt-40 md:pb-28 bg-white">
          ...
          <div className="md:w-1/3 flex justify-center">
            <div className="relative">
              <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden bg-gray-100 shadow-sm">
                <img
                  src={getImageUrl(aboutData.photo) || 'https://placehold.co/400x400/e2e8f0/1e293b?text=Perfil'}
                  alt="Rodrigo Durán"
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.src = 'https://placehold.co/400x400/e2e8f0/1e293b?text=Perfil'
                  }}
                />
              </div>
            </div>
