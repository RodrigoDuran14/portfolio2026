            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <a href={project.repo} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 text-white text-sm font-medium rounded-lg transition-colors bg-[var(--color-accent)] hover:bg-[var(--color-accent-dark)]">
                    <FaGithub size={16} />
                    {projectsData.button}
                  </a>
